...
export const metadata: Metadata = {
  title: "Terms of Service - WhatsMyName",
  description: "Terms and conditions for using WhatsMyName, including usage guidelines for our username availability checker.",
  alternates: {
  ...
  return (
    <>
      ...
      <div className="prose dark:prose-invert max-w-none">
        <h1>Terms of Service for WhatsMyName</h1>

        <p><strong>Last updated: July 8, 2025</strong></p>

        <h2>Introduction and Acceptance of Terms</h2>
        <p>
          Welcome to <strong>WhatsMyName</strong>, a free online username availability checker designed to help you find available usernames across multiple platforms. By accessing or using our username checker, you agree to be bound by these Terms of Service. If you do not agree with any of these terms, please do not use our service.
        </p>

        <h2>Description of Service</h2>
        <p>
          WhatsMyName provides users with comprehensive username checking tools including:
        </p>
        <ul>
          <li>Real-time username availability checking across multiple platforms</li>
          <li>Bulk username search functionality</li>
          <li>Username suggestions and alternatives</li>
          <li>Platform-specific username requirements</li>
          <li>Username history and analytics</li>
          <li>Export and save functionality for results</li>
        ...
        <ul>
          ...
          <li>Respect the intellectual property rights of WhatsMyName</li>
        ...
        <p>
          WhatsMyName operates without requiring user accounts, ensuring maximum privacy for your tax information. You can use our US Overseas Remittance Fee Calculator completely anonymously.
        </p>
        ...
        <p>
          All content provided through WhatsMyName, including the website design, calculation algorithms, tax formulas, user interface, and educational materials, is protected under copyright law and owned by <strong>WhatsMyName</strong>.
        </p>
        ...
        <ul>
          ...
          <li>Impersonating WhatsMyName or our representatives</li>
        ...
        <p>
          <strong>IMPORTANT:</strong> WhatsMyName provides tax estimates based on the information you provide and current tax laws. Our calculations are for informational purposes only and should not be considered as:
        </p>
        <ul>
        ...
        <h3>Free Service</h3>
        <p>
          WhatsMyName is provided free of charge. We reserve the right to:
        </p>
        <ul>
        ...
        <p>
          To the fullest extent permitted by law, WhatsMyName shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from:
        </p>
        <ul>
        ...
        <p>
          You agree to indemnify and hold harmless WhatsMyName, its operators, affiliates, and their respective officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorneys' fees) arising from:
        </p>
        <ul>
        ...
        <ul>
          ...
          <li><strong>Mailing Address:</strong> WhatsMyName Legal Team, 1234 Tax Avenue, Suite 2025, Washington, DC 20001</li>
        </ul>
        ...
        <p>
          <strong>By using WhatsMyName, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</strong> Thank you for choosing our free US Remittance Tax Calculator for your 2025 tax planning needs!
        </p>
